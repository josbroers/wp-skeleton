...
<head>
	...
	<link href="https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=block"
		rel="stylesheet">
	<?php try { ?>
		<link rel="preload" href="<?= ( new Assets() )->asset_path( 'resources/ts/main.ts' ) ?>" as="script">
		<link rel="preload" href="<?= ( new Assets() )->asset_path( 'resources/scss/main.scss' ) ?>" as="style">
